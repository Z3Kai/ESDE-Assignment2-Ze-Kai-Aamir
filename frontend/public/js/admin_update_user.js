...
if ($updateUserFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        let token = localStorage.getItem('token'); // added code ASSIGNMENT ONE
        ...
        axios({
                ...
                data: webFormData,
                headers: { 'Content-Type': 'multipart/form-data', 'user': userId,'authorization': 'Bearer ' + token } // added code ASSIGNMENT ONE 
            })
